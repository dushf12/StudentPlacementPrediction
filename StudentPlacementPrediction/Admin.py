...
class Ui_Admin(object):
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.resize(638, 449)
        Dialog.setStyleSheet("background-color: rgb(207, 138, 0);")
...
"font: 75 14pt \"Vani\";")
        ...
        self.pushButton.setGeometry(QtCore.QRect(190, 330, 101, 41))
        self.pushButton.setStyleSheet("background-color: rgb(0, 100, 147);\n"
...
"color: rgb(255, 255, 255);")
        ...
        self.label_4.setStyleSheet("image: url(../StudentPlacement/images/adminn.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "AdminLogin"))
